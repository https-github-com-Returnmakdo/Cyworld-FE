  ...
  return (
    <PageBox>
      ...
      <Posting>다이어리를 작성해 볼까요? <FontAwesomeIcon icon={faSquarePlus} style={{verticalAlign: "middle", marginLeft:"10px", scale:"1.6", cursor:"pointer"}} /></Posting>
        ...
        <DiaryImg><img alt="WindGirl" style={{width:"100%", height:"100%"}} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSti8jxsmMY-Ttt8TF1pyj6_a8sM7x338Exhw&usqp=CAU"/></DiaryImg>
        <PostContent>다이어리 글 내용</PostContent>
        <CommentInputBox>
          <Commentinput placeholder="댓글을 작성해주세요."/>
          <CommentSave><FontAwesomeIcon icon={faCheck} style={{marginTop:"-1.5px"}}/></CommentSave>
        </CommentInputBox>
        <CommentListBox>
          <Comment>댓글</Comment>
          <CommentEdit><FontAwesomeIcon icon={faPencil} style={{marginTop:"-1px"}}/></CommentEdit>
          <CommentDelete><FontAwesomeIcon icon={faTrashCan} style={{marginTop:"-1px"}}/></CommentDelete>
        </CommentListBox>
        <PostInfo>
          <PostDate>2022-10-29</PostDate>
          <PostNum>No.1</PostNum>
